...
CREATE TABLE IF NOT EXISTS damtom
(
    id                uuid          NOT NULL,
    tenant_id         uuid          NULL,
    asset_id          uuid          NULL,
    ...
    active            bool          NULL,
    CONSTRAINT damtom_pkey PRIMARY KEY (id)
);

CREATE TABLE IF NOT EXISTS damtom_permission
(
    id           uuid         NOT NULL,
    tenant_id    uuid         NULL,
    role_id      uuid         NULL,
    ...
    created_by   uuid         NULL,
    created_time int8         NOT NULL,
    CONSTRAINT damtom_permission_pkey PRIMARY KEY (id)
);

CREATE TABLE IF NOT EXISTS damtom_role
(
    id           uuid          NOT NULL,
    tenant_id    uuid          NULL,
    "name"       varchar(255)  NULL,
    ...
    created_by   uuid          NULL,
    created_time int8          NOT NULL,
    CONSTRAINT damtom_role_pkey PRIMARY KEY (id)
);

CREATE TABLE IF NOT EXISTS damtom_user_role
(
    id           uuid NOT NULL,
    tenant_id    uuid NULL,
    user_id      uuid NULL,
    ...
    created_by   uuid NULL,
    created_time int8 NOT NULL,
    CONSTRAINT damtom_user_role_pkey PRIMARY KEY (id)
);

CREATE TABLE IF NOT EXISTS damtom_user_active
(
    id            uuid       NOT NULL,
    tenant_id     uuid       NULL,
    user_id       uuid       NULL,
    active        bool default FALSE,
    activate_code varchar(6) NOT NULL,
    created_time  int8       NOT NULL,
    CONSTRAINT damtom_user_active_pkey PRIMARY KEY (id)
);

CREATE TABLE IF NOT EXISTS damtom_khachhang
(
    id             uuid          NOT NULL,
    ...
    ngay_bat_dau   date,
    active         bool default FALSE,
    tai_lieu       varchar       NULL,
    ghi_chu        varchar(4000) NULL,
    created_by     uuid          NULL,
    created_time   int8          NOT NULL,
    CONSTRAINT khach_hang_pkey PRIMARY KEY (id),
    CONSTRAINT fk_khach_hang_tenant FOREIGN KEY (tenant_id) REFERENCES tenant (id)
);

CREATE TABLE IF NOT EXISTS damtom_staff
(
    damtom_id    uuid NOT NULL,
    staff_id     uuid NOT NULL,
    created_by   uuid NULL,
    created_time int8 NOT NULL,
    CONSTRAINT damtom_staff_pkey PRIMARY KEY (damtom_id, staff_id)
);

CREATE TABLE IF NOT EXISTS damtom_gateway
(
    id           uuid NOT NULL,
    tenant_id    uuid NOT NULL,
    damtom_id    uuid NOT NULL,
    ...
    CONSTRAINT damtom_gateway_pkey PRIMARY KEY (id)
);

CREATE TABLE IF NOT EXISTS damtom_camera
(
    id           uuid NOT NULL,
    tenant_id    uuid NOT NULL,
    damtom_id    uuid NOT NULL,
    ...
    CONSTRAINT damtom_camera_pkey PRIMARY KEY (id)
);

CREATE TABLE IF NOT EXISTS damtom_alarm
(
    id                uuid    NOT NULL,
    tenant_id         uuid    NOT NULL,
    device_profile_id uuid    NOT NULL,
    ...
    via_sms           bool,
    via_email         bool,
    via_notification  bool,
    rpc_setting_id    uuid,
    rpc_mode          uuid,
    created_by        uuid,
    created_time      int8,
    CONSTRAINT damtom_alarm_pkey PRIMARY KEY (id),
    CONSTRAINT fk_dtalarm_dt FOREIGN KEY (damtom_id) REFERENCES damtom (id),
    CONSTRAINT fk_dtalarm_dvprofile FOREIGN KEY (device_profile_id) REFERENCES device_profile (id)
);

CREATE TABLE IF NOT EXISTS damtom_user_avatar
(
    id      uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS damtom_report_schedule
(
    id            uuid    NOT NULL,
    tenant_id     uuid    NOT NULL,
    damtom_id     uuid    NOT NULL,
    ...
    created_time  int8,
    active        bool default TRUE,
    CONSTRAINT damtom_report_schedule_pkey PRIMARY KEY (id)
);

CREATE TABLE IF NOT EXISTS damtom_report_schedule_user
(
    schedule_id  uuid NOT NULL,
    user_id      uuid NOT NULL,
    created_by   uuid NULL,
    created_time int8 NOT NULL,
    CONSTRAINT damtom_report_schedule_user_pkey PRIMARY KEY (schedule_id, user_id)
);

CREATE TABLE IF NOT EXISTS damtom_snapshot
(
    id            uuid          NOT NULL,
    tenant_id     uuid          NOT NULL,
    damtom_id     uuid          NOT NULL,
    alarm_id      uuid          NOT NULL,
    alarm_name    varchar(4000) NOT NULL,
    data_snapshot varchar(4000) NOT NULL,
    time_snapshot int8          NOT NULL,
    clear         bool,
    CONSTRAINT damtom_snapshot_pkey PRIMARY KEY (id)
);

CREATE TABLE IF NOT EXISTS damtom_notify_token
(
    id           uuid          NOT NULL,
    user_id      uuid          NOT NULL,
    notify_token varchar(4000) NOT NULL,
    CONSTRAINT damtom_notify_token_key PRIMARY KEY (id)
);

CREATE TABLE IF NOT EXISTS damtom_notification_log
(
    id           uuid NOT NULL,
    tenant_id    uuid NOT NULL,
    user_id      uuid,
    ...
    CONSTRAINT damtom_notification_log_pkey PRIMARY KEY (id)
);

CREATE TABLE IF NOT EXISTS damtom_report_ketnoi
(
    id               uuid    NOT NULL,
    tenant_id        uuid    NOT NULL,
    damtom_id        uuid    NOT NULL,
    ...
    last_active_time int8    NOT NULL,
    created_time     int8,
    CONSTRAINT damtom_report_ketnoi_pkey PRIMARY KEY (id)
);

CREATE TABLE IF NOT EXISTS damtom_rpc_command_queue
(
    id             uuid    NOT NULL,
    tenant_id      uuid    NOT NULL,
    damtom_id      uuid    NOT NULL,
...
CREATE TABLE IF NOT EXISTS damtom_group_rpc
(
    id           uuid    NOT NULL,
    tenant_id    uuid    NOT NULL,
    damtom_id    uuid    NOT NULL,
    ...
    created_by   uuid    NULL,
    created_time int8    NOT NULL,
    CONSTRAINT damtom_group_rpc_pkey PRIMARY KEY (id)
);

CREATE TABLE IF NOT EXISTS damtom_rpc_scheduler
(
    id             uuid    NOT NULL,
    tenant_id      uuid    NOT NULL,
    damtom_id      uuid    NOT NULL,
    ...
    created_time   int8    NOT NULL,
    CONSTRAINT damtom_rpc_scheduler_pkey PRIMARY KEY (id)
);

CREATE TABLE IF NOT EXISTS damtom_rpc_setting
(
    id              uuid         NOT NULL,
    device_id       uuid         NOT NULL,
    device_name     varchar(255) NOT NULL,
    value_control   double precision,
    delay_time      int8,
    callback_option bool         NOT NULL,
    time_callback   int8,
    loop_option     bool         NOT NULL,
    loop_count      int,
    loop_time_step  int8,
    group_rpc_id    uuid,
    command_id      int,
    created_time    int8,
    CONSTRAINT damtom_rpc_setting_pkey PRIMARY KEY (id)
);
