...
public class ThingsboardSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    // trungdt - public user api
    public static final String PUBLIC_ENTRY_POINTS = "/public-api/**";
    ...
    // normal request with token provider
    @Autowired private JwtAuthenticationProvider jwtAuthenticationProvider;
    // api refresh token provider
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.headers().cacheControl().and().frameOptions().disable()
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/trungdt/test").permitAll()
                .antMatchers(PUBLIC_ENTRY_POINTS).permitAll() // trungdt - public apis
