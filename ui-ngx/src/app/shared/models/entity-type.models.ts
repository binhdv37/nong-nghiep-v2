...
export const entityTypeTranslations = new Map<EntityType | AliasEntityType, EntityTypeTranslation>(
  [
    ...
    [
      EntityType.DAMTOM,
      {
        type: 'dft.damtom.type',
        typePlural: 'dft.damtom.typePlural',
        list: 'dft.damtom.list',
        nameStartsWith: 'dft.damtom.nameStartsWith',
        details: 'dft.damtom.details',
        add: 'dft.damtom.add',
        noEntities: 'dft.damtom.noEntities',
        search: 'dft.damtom.search',
        selectedEntities: 'dft.damtom.selectedEntities'
      }
    ],
    [
      EntityType.USER_DFT,
      {
        type: 'dft.users.type',
        typePlural: 'dft.users.typePlural',
        list: 'dft.users.list',
        nameStartsWith: 'dft.users.nameStartsWith',
        details: 'dft.users.details',
        add: 'dft.users.add',
        noEntities: 'dft.users.noEntities',
        search: 'dft.users.search',
        selectedEntities: 'dft.users.selectedEntities'
      }
    ],
    [
      EntityType.KHACHHANG,
      {
        type: 'dft.admin.khachhang.type',
        typePlural: 'dft.admin.khachhang.typePlural',
        list: 'dft.admin.khachhang.list',
        nameStartsWith: 'dft.admin.khachhang.nameStartsWith',
        details: 'dft.admin.khachhang.details',
        add: 'dft.admin.khachhang.add',
        noEntities: 'dft.admin.khachhang.noEntities',
        search: 'dft.admin.khachhang.search',
        selectedEntities: 'dft.admin.khachhang.selectedEntities'
      }
    ]
  ]
);
