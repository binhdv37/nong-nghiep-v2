...
export class AuthService {
  ...
  // binhdv - custom forget password link
  public dftResetPasswordRequest(email: string) {
    return this.http.post('/api/noauth/dft/resetpassword',
  ...
  public dftCustomChangePassword(currentPassword: string, newPassword: string) {
    return this.http.post('/api/auth/dft-custom-changePassword',
      {currentPassword, newPassword}, defaultHttpOptions());
  }
