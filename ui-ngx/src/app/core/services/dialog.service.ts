...
import {ConfirmSaveDiaglogComponent} from '@shared/components/dialog/confirm-save-diaglog/confirm-save-diaglog.component';
...
export class DialogService {
  ...
  confirmSave(title: string, message: string, cancel: string = null, ok: string = null, fullscreen: boolean = false): Observable<boolean> {
    const dialogConfig: MatDialogConfig = {
      disableClose: true,
      data: {
        title,
    ...
    const dialogRef = this.dialog.open(ConfirmSaveDiaglogComponent, dialogConfig);
    return dialogRef.afterClosed();
  }
