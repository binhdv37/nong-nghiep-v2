...
export class UserService {
  ...
  // binhdv - custom save user api for profile screen
  public dftCustomSaveUser(user: User, config?: RequestConfig): Observable<User> {
    const url = '/api/user/dft-custom-profile';
    return this.http.post<User>(url, user, defaultHttpOptionsFromConfig(config));
  }
