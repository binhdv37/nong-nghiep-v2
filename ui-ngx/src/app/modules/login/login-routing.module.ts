...
import {DftResetPasswordRequestComponent} from "@modules/login/pages/dft-reset-password-request/dft-reset-password-request.component";
...
const routes: Routes = [
  ...
  // binhdv - custom forget password component
  {
    path: 'login/resetPasswordRequest',
    component: DftResetPasswordRequestComponent,
    data: {
      title: 'login.request-password-reset',
      module: 'public'
    },
